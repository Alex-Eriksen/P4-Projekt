...
namespace Wizard_Battle_Web_API.Migrations
{
    ...
    [Migration("20221114100236_initialcreate2")]
            ...
            modelBuilder.Entity("Wizard_Battle_Web_API.Database.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$10$.dkmW.emBoV4xNIUXKAkBuTTfDMLvoys4tpyRD/4kdrl1o.m/SSxS"
                        },
                        new
                        {
                            AccountID = 2,
                            ...
                            Last_Login = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Modified_At = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "$2a$10$mGJZb6Ytxpj3EF/A5e4SZOU8ABg0aJAXJ8flbwdzzpAvWzqRD8.QO"
                        },
                        new
                        {
                            AccountID = 3,
                            ...
                            Last_Login = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Modified_At = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "$2a$10$uOoUh5QhdZym1KHfLe4LmeaTf/rCZRhQOB/WmyPqnqw8gsH3YzvhK"
                        },
                        new
                        {
                            AccountID = 4,
                            ...
                            Last_Login = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Modified_At = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "$2a$10$Mr5OnI/NOzXx1E2Dov0bx.f0Pe7O1dysS.xe7nhJpnMPPX4fa0lSO"
                        });
                });
            ...
            modelBuilder.Entity("Wizard_Battle_Web_API.Database.Entities.Friendship", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MainPlayerID = 1,
                            FriendPlayerID = 2,
                            Created_At = new DateTime(2022, 11, 14, 10, 2, 36, 73, DateTimeKind.Utc).AddTicks(456),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 1,
                            FriendPlayerID = 3,
                            Created_At = new DateTime(2022, 11, 14, 10, 2, 36, 73, DateTimeKind.Utc).AddTicks(471),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 1,
                            FriendPlayerID = 4,
                            Created_At = new DateTime(2022, 11, 14, 10, 2, 36, 73, DateTimeKind.Utc).AddTicks(478),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 2,
                            FriendPlayerID = 3,
                            Created_At = new DateTime(2022, 11, 14, 10, 2, 36, 73, DateTimeKind.Utc).AddTicks(485),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 2,
                            FriendPlayerID = 4,
                            Created_At = new DateTime(2022, 11, 14, 10, 2, 36, 73, DateTimeKind.Utc).AddTicks(492),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 3,
                            FriendPlayerID = 4,
                            Created_At = new DateTime(2022, 11, 14, 10, 2, 36, 73, DateTimeKind.Utc).AddTicks(499),
                            IsPending = false
                        });
                });
