...
namespace Wizard_Battle_Web_API.Migrations
{
    ...
    [Migration("20221116112427_initialcreate")]
            ...
            modelBuilder.Entity("Wizard_Battle_Web_API.Database.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$10$ppNaaXpf7Bpew6cOqi9Y7er8arBFGz0y4zHr778EyR/3JTG.3tlme"
                        },
                        new
                        {
                            AccountID = 2,
                            ...
                            Last_Login = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Modified_At = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "$2a$10$ts2ECZdbQMGJaGAzAln67OJ6q0JD6hBrLk0pcGS34xX1wxfeUylxm"
                        },
                        new
                        {
                            AccountID = 3,
                            ...
                            Last_Login = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Modified_At = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "$2a$10$3pig4tTVCswxku8.cyLan.P5SHJMJ/mm0R5vRRIuKcZJSyKB1ozB2"
                        },
                        new
                        {
                            AccountID = 4,
                            ...
                            Last_Login = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Modified_At = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "$2a$10$8kntGwf/EvxdckVcWT3f7uM2IB/ylcSnlC73qHzRefXOrhseK7zhy"
                        });
                });
            ...
            modelBuilder.Entity("Wizard_Battle_Web_API.Database.Entities.Friendship", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MainPlayerID = 1,
                            FriendPlayerID = 2,
                            Created_At = new DateTime(2022, 11, 16, 11, 24, 27, 59, DateTimeKind.Utc).AddTicks(9435),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 1,
                            FriendPlayerID = 3,
                            Created_At = new DateTime(2022, 11, 16, 11, 24, 27, 59, DateTimeKind.Utc).AddTicks(9448),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 1,
                            FriendPlayerID = 4,
                            Created_At = new DateTime(2022, 11, 16, 11, 24, 27, 59, DateTimeKind.Utc).AddTicks(9455),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 2,
                            FriendPlayerID = 3,
                            Created_At = new DateTime(2022, 11, 16, 11, 24, 27, 59, DateTimeKind.Utc).AddTicks(9461),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 2,
                            FriendPlayerID = 4,
                            Created_At = new DateTime(2022, 11, 16, 11, 24, 27, 59, DateTimeKind.Utc).AddTicks(9468),
                            IsPending = false
                        },
                        new
                        {
                            MainPlayerID = 3,
                            FriendPlayerID = 4,
                            Created_At = new DateTime(2022, 11, 16, 11, 24, 27, 59, DateTimeKind.Utc).AddTicks(9514),
                            IsPending = false
                        });
                });
